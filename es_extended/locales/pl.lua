Locales['pl'] = {
  ...
  ['gave_weapon'] = 'dałeś/aś ~y~1x~s~ ~b~%s~s~ to ~y~%s~s~.',
  ['gave_weapon_ammo'] = 'dałeś/a ~y~1x~s~ ~b~%s~s~ with ~o~%sx~s~ ammo do ~y~%s~s~.',
  ['gave_weapon_hasalready'] = '~y~%s~s~ już posiadasz ~y~%s~s~',
  ['received_weapon'] = 'dostałeś ~y~1x~s~ ~b~%s~s~ od ~b~%s~s~.',
  ['received_weapon_ammo'] = 'dostałeś ~y~1x~s~ ~b~%s~s~ z ~o~%sx~s~ ammo od ~b~%s~s~.',
  ['received_weapon_hasalready'] = '~b~%s~s~ próbował dać ci ~y~%s~s~, ale już posiadasz.',
  ...
  ['threw_weapon_ammo'] = 'wyrzuciłeś/aś ~y~1x~s~ ~b~%s~s~ z ~o~%sx~s~ ammo',

  ['received_salary'] = 'otrzymałeś/aś wypłatę: %s$',
  ['received_help'] = 'otrzymałeś/aś wypłatę: %s$',
  ...
  ['weapon_snspistol_mk2'] = 'sns pistolet mk II',
